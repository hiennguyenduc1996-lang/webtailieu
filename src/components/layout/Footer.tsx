    ...
    <footer className="bg-navy text-white py-16 border-t border-white/5">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold tracking-tight">Đề Thi Tiếng Anh NK12</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-slate-400">
              ...
              <li><a href="/category/prediction" className="hover:text-white transition-colors">Phát triển & Dự đoán</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-amber uppercase tracking-widest text-xs mb-6">Liên hệ</h4>
            <ul className="space-y-3 text-sm text-slate-400">
              <li>Email: hiennguyenduc1996@gmail.com</li>
              <li>Facebook: <a href="https://www.facebook.com/nguyen.hien.828861" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">fb.com/nguyen.hien.828861</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500 font-medium">
          <p>© {new Date().getFullYear()} Đề Thi Tiếng Anh NK12. All rights reserved.</p>
